# LATEST: the opening animation is back (center stage, once per session), the "stopped" video explained, Today in Denmark modernised, and the compass is gold everywhere
