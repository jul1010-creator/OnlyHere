# LATEST: fixed the Craft crash, real travel times from Google Maps (not guesses), a progress readout while Studio researches, and two new fact-check rules aimed straight at the Gellerup errors
