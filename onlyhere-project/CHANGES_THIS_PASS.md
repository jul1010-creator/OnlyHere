# LATEST: found the real filter bug (not the freeze, a different one), compass-only intro, a shorter guide wait, and a Sonnet-writes-everything rule for guides
