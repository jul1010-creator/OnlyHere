export const freeEntrance = [
  ...
  { id: 3, name: "Ole's Garden, University Park", popularityTag: "Hidden Gem", city: "Aarhus", type: "Hidden park", emoji: "🌳", photo: "/attractions/oles-garden.jpg", desc: "A serene, secret park hidden inside Aarhus University's yellow-brick campus — largely known only to local students.", website: "https://www.au.dk/", color: "#558B2F" },
  // ── AALBORG ──
  { id: 4, name: "Lindholm Høje", popularityTag: "Common Attraction", city: "Aalborg", type: "Ancient burial site (outdoor)", emoji: "⛰", photo: "/attractions/lindholm-hoje.jpg", desc: "A breathtaking ancient Viking burial site with nearly 700 graves, free to walk year-round. The paired indoor museum charges a small entry fee.", website: "https://nordjyskemuseer.dk/u/vikingemuseet-lindholm-hoje/", color: "#1565C0",
    blogBody: [
      { type: "heading", content: "What Makes It Special" },
  ...
  { id: 5, name: "The Singing Trees", popularityTag: "Hidden Gem", city: "Aalborg", type: "Musical park installation", emoji: "🎵", photo: "/attractions/singing-trees.jpg", desc: "International stars — Elton John, Sting — have planted trees here. Press the button at each tree to hear their music.", website: "https://akkc.dk/de-syngende-traeer/", color: "#D4AF37",
    blogBody: [
      { type: "heading", content: "What Makes It Special" },
  ...
  { id: 11, name: "Medical Herb Garden, Kastellet", popularityTag: "Hidden Gem", city: "Copenhagen", type: "Hidden garden", emoji: "🌱", photo: "/attractions/medical-herb-garden-kastellet.jpg", desc: "A tiny, secluded herb patch inside the star-fortress of Kastellet — bypassed by most tourists rushing to the Little Mermaid.", website: "https://www.kastelletsvenner.dk/", color: "#558B2F" },
  { id: 12, name: "Kastellet", popularityTag: "Common Attraction", city: "Copenhagen", type: "Star fortress & waterfront walk", emoji: "🛡", photo: "/attractions/kastellet.jpg", desc: "One of Europe's best-preserved star fortresses — centuries of military history combined with some of Copenhagen's best waterfront walks. Completely free, and a genuinely better use of your time than just photographing the Little Mermaid next door.", website: null, color: "#455A64",
    blogBody: [
      { type: "heading", content: "What Makes It Special" },
  ...
  { id: 14, name: "Medical Herb Garden (Lægeurtehaven)", popularityTag: "Hidden Gem", city: "Aalborg", type: "Monastery herb garden", emoji: "🌿", photo: "/attractions/medical-herb-garden-laegeurtehaven.jpg", desc: "Tucked beside Aalborg's historic monastery, a small peaceful green space inspired by the medicinal gardens once maintained by monks.", website: null, color: "#558B2F",
    blogBody: [
      { type: "heading", content: "What Makes It Special" },
