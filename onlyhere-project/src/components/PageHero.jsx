export const PageHero = ({ src, emoji, color }) => (
  <div className="page-hero-box" style={{ borderRadius: 14, overflow: "hidden", marginBottom: 18, position: "relative", background: `linear-gradient(135deg, ${color}33 0%, #0A0F1E 100%)` }}>
